public class Automovil implements Comparable<Automovil> {
    ...
    public static final String COLOR_GRIS = "GRIS_OSCURO";
    ...
    public String acelerar(int rpm) {
        return "el alto " + this.fabricante + "acelerando a " + rpm + "rpm";
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (this.fabricante != null && this.modelo != null
                && this.fabricante.equals(car.getFabricante())
                && this.modelo.equals(car.getModelo()));
    }
