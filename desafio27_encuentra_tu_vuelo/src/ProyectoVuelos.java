...
public class ProyectoVuelos {
    public static void main(String[] args) throws ParseException {
        ...
        llegadas.sort((v1, v2) -> Integer.valueOf(v1.getNumeroPasajeros()).compareTo(v2.getNumeroPasajeros()));
        Vuelo vueloMayorNumero = new LinkedList<>(llegadas).peekLast();
        System.out.println("El vuelo con mayor número de pasajeros es " + vueloMayorNumero.getNombre() + ": " + vueloMayorNumero.getOrigen()+ ", con " + vueloMayorNumero.getNumeroPasajeros() + " pasajeros.");
