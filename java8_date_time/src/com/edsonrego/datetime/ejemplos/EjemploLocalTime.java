...
public class EjemploLocalTime {
    public static void main(String[] args) {
        ...
        LocalTime sieteConTreinta = LocalTime.of(6,30, 59).plus(1, ChronoUnit.HOURS);
        ...
        ahoraFormateado = dtf.format(ahora);
        System.out.println("ahoraFormateado = " + ahoraFormateado);
        ...
        String ahoraFormatead2 = seisConTreinta.format(dtf);
        System.out.println("ahoraFormatead2 = " + ahoraFormatead2);
