package com.edsonrego.java.jdbc.repositorio;
...
public class CategoriRepositorioImpl implements Repositorio<Categoria>{

    private Connection conn;

    public CategoriRepositorioImpl(Connection conn) {
        this.conn = conn;
    }

    public CategoriRepositorioImpl() {
    }
