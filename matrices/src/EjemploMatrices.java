public class EjemploMatrices {
    public static void main(String[] args) {
        ...
        System.out.println("Quantidade colunas: " + numeros[0].length);
        System.out.println("Primero elemento de la matrice " + numeros[0][0]);
        System.out.println("Ultimo elemento de la matrice: " + numeros[numeros.length-1][numeros[1].length -1]);
